      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mt-8 space-y-8">
          ...
          >
            ...
            <Note>
              나중에 얼마든지 고칠 수 있으니 처음부터 완벽하게 짜지 않아도 됩니다.
              단계를 고치는 방법은 아래를 보세요.
            </Note>
            ...
            <p>
              <b>메모</b> 칸을 눌러 학생마다 한 줄씩 적어 둡니다. 칸을 벗어나거나{" "}
              <b>Enter</b>를 누르면 저장되고, <b>Esc</b>를 누르면 되돌아갑니다.
              &lsquo;어머니 상담 완료&rsquo;, &lsquo;서류 1부 부족&rsquo; 같은 것을
              적어 두면 다음에 볼 때 도움이 됩니다. 누가 언제 단계를 바꿨는지도 남습니다.
            </p>

            <h3 className="pt-2 text-base font-bold">단계 고치기</h3>
            <Shot
              src="/help/stage-edit.png"
              alt="진행 명단의 단계 고치기 — 이름 · 순서 · 종류를 바꾸는 화면"
              caption="단계 줄 오른쪽 끝의 ‘단계 고치기’를 누르면 열립니다."
              height={700}
            />
            <p>
              만든 뒤에도 단계 <b>이름</b>과 <b>순서</b>를 바꾸고, 빠진 단계를{" "}
              <b>더할</b> 수 있습니다. 면접이 2차까지 늘어나거나 이름을 잘못 적었을 때
              쓰세요.
            </p>
            <p>
              <b>이름을 고쳐도 그 단계에 있던 학생은 그대로 남습니다.</b> 마음 놓고
              고치세요.
            </p>
            <Note>
              <b>학생이 남아 있는 단계는 지울 수 없습니다.</b> ×가 흐리게 보이는
              단계가 그렇습니다. 지우려면 그 학생들을 먼저 다른 단계로 옮기세요.
              말없이 &lsquo;단계 없음&rsquo;으로 만들어 버리면 나중에 찾기 어렵기
              때문입니다.
            </Note>
            <p>
              일정 <b>편집</b> 화면에서도 같은 일을 할 수 있습니다. 거기서는 단계와
              공개 범위만 다루고, 학생을 담고 빼는 것은 명단에서 합니다.
            </p>

            <h3 className="pt-2 text-base font-bold">켜고 끄기</h3>
            <p>
              등록할 때 켜지 않았더라도 나중에 쓸 수 있습니다. 일정을 열면{" "}
              <b>단계 묶음을 고르세요</b>가 나오고, 거기서 고르면 그때부터 명단이
              생깁니다.
            </p>
            <p>
              잘못 켰거나 더는 필요 없어지면 일정 <b>편집</b> 화면 맨 아래{" "}
              <b>진행 명단 끄기</b>로 되돌립니다.
            </p>
            <Note>
              <b>끄면 되돌릴 수 없습니다.</b> 담아 둔 학생과 단계, 누가 언제 단계를
              옮겼는지의 기록이 모두 사라집니다. 일정 삭제와 달리 휴지통에 남지
              않습니다. 몇 명과 몇 개가 사라지는지 눌렀을 때 알려 드리니 숫자를
              보고 정하세요. 일정 자체와 댓글 · 첨부파일은 그대로 있습니다.
            </Note>
          </Section>
